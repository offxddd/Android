...
public class MyProvider  extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        db.execSQL("insert into contacts values(1,'ccc','13433333333','男');");
        db.execSQL("insert into contacts values(2,'ddd','14344444444','男');");
        db.execSQL("insert into contacts values(3,'aaa','15464646879','男');");
        db.execSQL("insert into contacts values(4,'bbb','17978456123','男');");
